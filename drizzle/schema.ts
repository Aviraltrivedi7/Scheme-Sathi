...
export const documentReviewAssignments = mysqlTable("document_review_assignments", {
  ...
  escalationState: mysqlEnum("escalationState", ["normal", "escalated", "resolved"]).default("normal").notNull(),
...
export const documentReviewAuditEvents = mysqlTable("document_review_audit_events", {
  ...
  kind: mysqlEnum("kind", ["assigned", "started", "completed", "revoked", "noteCreated", "noteUpdated", "noteDeleted", "dueReminderSent", "reminderSnoozed", "escalated", "escalationResolved"]).notNull(),
  detail: varchar("detail", { length: 500 }),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
