...
const reviewerAlertPreferenceInput = z.object({ assignmentAlertsEnabled: z.boolean(), dueDateRemindersEnabled: z.boolean(), defaultReminderLeadHours: z.number().int().min(1).max(168) });
